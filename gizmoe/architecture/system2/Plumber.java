...
public class Plumber
{
   public static void main( String argv[])
   {
		...
		****************************************************************************/
		...
		WildValueExtrapolationFilter Filter5 = new WildValueExtrapolationFilter();
		WriteToFileFilter Filter6 = new WriteToFileFilter();
		WriteWildValuesToFileFilter Filter7 = new WriteWildValuesToFileFilter();
		/****************************************************************************
		* Here we connect the filters starting with the sink filter (Filter 1) which
		* we connect to Filter2 the middle filter. Then we connect Filter2 to the
		* source filter (Filter3).
		****************************************************************************/
		Filter7.Connect(Filter5,2);
